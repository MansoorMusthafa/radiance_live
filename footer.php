    ...
    <script>
        ...
        function setActiveIconOnLoad() {
            ...
            if (activeIndex !== null) {
                ...
                // If active icon index is not set, check if the current URL matches any of the footer links
                var currentUrl = window.location.pathname.split('/').pop(); // Get the current filename from the URL
                var footerLinks = document.querySelectorAll('.icon-link');
        ...
        // Set active state immediately after the page loads
        setActiveIconOnLoad();
    </script>
</body>
